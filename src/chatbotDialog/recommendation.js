...
module.exports = [
    (session, args, next) => {
        ...
        builder.Prompts.choice(session, 'How is the car that you need?','Familiar|Personal',{listStyle: builder.ListStyle.button,retryPrompt: 'I \'m sorry, I didn\'t understand that, please select another option'});
    },
    (session, results) => {
